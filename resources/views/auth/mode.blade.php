...
<body>
  ...
  <div class="welcome-message">
    ...
    <!-- OFFLINE -->
    <a href="{{ route('home') }}" class="mode-button" role="button" aria-label="Choose offline dining">
    ...
    <!-- ONLINE -->
    <a href="{{ route('home') }}" class="mode-button" role="button" aria-label="Choose online reservation">
        <span class="mode-icon">📅</span>
