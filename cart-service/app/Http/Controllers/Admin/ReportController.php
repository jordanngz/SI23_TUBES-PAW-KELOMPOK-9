...
class ReportController extends Controller
{
    public function index()
    {
        ...
        // Total Revenue
        $totalRevenue = OrderItem::join('db_menu.products', 'order_items.product_id', '=', 'products.id')
        ...
        for ($i = 6; $i >= 0; $i--) {
            ...
            $chartLabels[] = $label;
            $revenue = OrderItem::join('db_menu.products', 'order_items.product_id', '=', 'products.id')
